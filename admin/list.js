// Attach Add Perfume button to open Add Bottle modal
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const closeAddBottleBtn = document.querySelector('.add-bottle-close');
            // You can add a button somewhere to open this modal, e.g. document.getElementById('openAddBottleModal').onclick = ...
            // For now, open with window.openAddBottleModal()
            window.openAddBottleModal = function () {
                addBottleModal.style.display = 'flex';
            };
            closeAddBottleBtn.addEventListener('click', function () {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const closeAddListBtn = document.querySelector('.add-list-close');
            ...
            document.getElementById('addListForm').addEventListener('submit', function (e) {
                e.preventDefault();
                // You can add your logic here to actually add the list
                addListModal.style.display = 'none';
                this.reset();
                alert('List added! (Demo)');
            });
        });
        document.addEventListener('DOMContentLoaded', function () {
            const modal = document.getElementById('bottlePreviewModal');
            const modalImg = document.getElementById('bottlePreviewImg');
            const closeBtn = document.querySelector('.bottle-preview-close');
